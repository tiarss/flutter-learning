        ...
        body: LayoutBuilder(
          builder: (BuildContext context, BoxConstraints constraints) {
            if (constraints.maxWidth <= 600) {
              ...
              return const TourismPlaceGrid(gridCount: 4, spacing: 2);
            } else {
              return const TourismPlaceGrid(gridCount: 6, spacing: 16);
            }
          },
        ));
  }
...
class TourismPlaceGrid extends StatelessWidget {
  ...
  const TourismPlaceGrid(
      {Key? key, required this.gridCount, required this.spacing})
      : super(key: key);
